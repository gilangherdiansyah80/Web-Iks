...
<header class="fixed-top">
    ...
    <main style="margin-top: 5rem;">
      <div class="main-content">
        <h2>Ketua Ranting Cabang Bandung</h2>

          <div class="container-card">
            <img class="image_kepengurusan" src="../img/perintisiks.jpg" alt="">
            <div class="deskripsi_kepengurusan mt-3">
              <p>Nama : Munadiyono</p>
              <p>Perintis pertama IKS.PI KERA SAKTI Cabang Bandung</p>
            </div>
          </div>

          <div class="container-card">
            <img class="image_kepengurusan" src="../img/rantingsukajadi.png" alt="">
            <div class="deskripsi_kepengurusan mt-3">
              <p>Nama : Riyadi</p>
              <p>Ketua Ranting : Sukajadi</p>
            </div>
          </div>

          <div class="container-card">
            <img class="image_kepengurusan" src="../img/rantingpasadena.png" alt="">
            <div class="deskripsi_kepengurusan mt-3">
              <p>Nama : Handoko</p>
              <p>Ketua Ranting : Caringin</p>
            </div>
          </div>
          <div class="container-card">
            <img class="image_kepengurusan" src="../img/ketuacilenyui.png" alt="">
            <div class="deskripsi_kepengurusan mt-3">
              <p>Nama : Ervan</p>
              <p>Ketua Ranting : Cileunyi</p>
            </div>
          </div>
          <div class="container-card">
            <img class="image_kepengurusan" src="../img/rantingrancamanyar.jpg" alt="">
            <div class="deskripsi_kepengurusan mt-3">
              <p>Nama : Indra</p>
              <p>Ketua Ranting : Rancamanyar</p>
            </div>
          </div>
          <div class="container-card">
            <img class="image_kepengurusan" src="../img/rantingbojongsoang.jpg" alt="">
            <div class="deskripsi_kepengurusan mt-3">
              <p>Nama : Anton</p>
              <p>Ketua Ranting : Bojongsoang</p>
            </div>
          </div>
      </div>
    </main>
