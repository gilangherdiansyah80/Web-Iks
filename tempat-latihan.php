    ...
    <main style="margin-top: 5rem;">
      <div class="main-content">
        <h2>Tempat Latihan</h2>
          ...
          Tempat Latihan Ranting Sukajadi :
            <br>
            1. Jl. PDAM No. 18 Sukamulya
            <br>
            2. SMA YPI jl.muhammad no.17 pamoyanan
            <br><br>

            Tempat Latihan Ranting Rancamanyar :
            <br>
            1. Rancamanyar
            <br>
            2. Sukamukti2
            ...
            Tempat Latihan Ranting Caringin :
            <br>
            SOR Pasadena jl.pasadena no.07
            <br><br>

            Tempat Latihan Ranting Cileunyi :
            <br>
            Perumahan Bumi Panyawangan
            <br><br>

            Tempat Latihan Ranting Buah Batu :
            <br>
            1. Universitas Telkom jl.Telekomunikasi no.01
            <br>
            2. Bojongsoang Lapangan Graha Permata Asri
            <br>
            3. Pondok Pesantren Albasyariah 3 Arjasari
            <br><br>

            Tempat Ltihan Ranting Rancaekek :
            <br>
            MA Plus Darul Hufadz
          </div>
      </div>
    </main>
