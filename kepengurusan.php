      ...
      <div class="main-content">
        <h2>Struktur Kepengurusan</h2>
          ...
          <div class="container-card">
            <img class="image_kepengurusan" src="img/penasehat.jpg" alt="">
            <div class="deskripsi_kepengurusan mt-3">
              <p>Nama : NARTO BASKORO</p>
              <p>Sebagai : PENASEHAT</p>
            </div>
          </div>

          <div class="container-card">
            <img class="image_kepengurusan" src="img/ketuacabangbandung.jpg" alt="">
            <div class="deskripsi_kepengurusan mt-3">
              <p>Nama :  AZIS RIAWAN</p>
              <p>Sebagai : KETUA CABANG</p>
            </div>
          </div>

          <div class="container-card">
            <img class="image_kepengurusan" src="img/wakilketua.jpg" alt="">
            <div class="deskripsi_kepengurusan mt-3">
              <p>Nama : ANDI MURJITO</p>
              <p>Sebagai : WAKIL KETUA CABANG</p>
            </div>
          </div>
          <div class="container-card">
            <img class="image_kepengurusan" src="img/sekertaris1.jpg" alt="">
            <div class="deskripsi_kepengurusan mt-3">
              <p>Nama : SETYO ARI K</p>
              <p>Sebagai : SEKERTARIS 1</p>
            </div>
          </div>
          <div class="container-card">
            <img class="image_kepengurusan" src="img/sekertaris2.jpg" alt="">
            <div class="deskripsi_kepengurusan mt-3">
              <p>Nama : WULANDARI</p>
              <p>Sebagai : SEKERTARIS 2</p>
            </div>
          </div>
          <div class="container-card">
            <img class="image_kepengurusan" src="img/bendahara1.jpg" alt="">
            <div class="deskripsi_kepengurusan mt-3">
              <p>Nama : SUMIATUN</p>
              <p>Sebagai : BENDAHARA 1</p>
            </div>
          </div>
          <div class="container-card">
            <img class="image_kepengurusan" src="img/bendahara2.jpg" alt="">
            <div class="deskripsi_kepengurusan mt-3">
              <p>Nama : ANISA DWI N</p>
              <p>Sebagai : BENDAHARA 2</p>
            </div>
          </div>
          <div class="container-card">
            <img class="image_kepengurusan" src="img/bendahara3.jpg" alt="">
            <div class="deskripsi_kepengurusan mt-3">
              <p>Nama : GILANG H S</p>
              <p>Sebagai : BENDAHARA 3</p>
            </div>
          </div>
          <div class="container-card">
            <img class="image_kepengurusan" src="img/dewanteknik1.jpg" alt="">
            <div class="deskripsi_kepengurusan mt-3">
              <p>Nama : NIKO H</p>
              <p>Sebagai : DEWAN TEHNIK 1</p>
            </div>
          </div>
          <div class="container-card">
            <img class="image_kepengurusan" src="img/dewanteknik2.jpg" alt="">
            <div class="deskripsi_kepengurusan mt-3">
              <p>Nama : ARI GIFARI</p>
              <p>Sebagai : DEWAN TEHNIK 2</p>
            </div>
          </div>
          <div class="container-card">
            <img class="image_kepengurusan" src="img/dewanteknik3.jpg" alt="">
            <div class="deskripsi_kepengurusan mt-3">
              <p>Nama : SUDIONO</p>
              <p>Sebagai : DEWAN TEHNIK 3</p>
            </div>
          </div>
          <div class="container-card">
            <img class="image_kepengurusan" src="img/humas1.jpg" alt="">
            <div class="deskripsi_kepengurusan mt-3">
              <p>Nama : EKO ARDI</p>
              <p>Sebagai : HUMAS 1</p>
            </div>
          ...
          <div class="container-card">
            <img class="image_kepengurusan" src="img/humas2.png" alt="">
            <div class="deskripsi_kepengurusan mt-3">
              <p>Nama : B. SURATNO</p>
              <p>Sebagai : HUMAS 2</p>
            </div>
          ...
          <div class="container-card">
            <img class="image_kepengurusan" src="img/humas3.png" alt="">
            <div class="deskripsi_kepengurusan mt-3">
              <p>Nama : YATNO</p>
              <p>Sebagai : HUMAS 3</p>
            </div>
          ...
          <div class="container-card">
            <img class="image_kepengurusan" src="img/humas4.jpg" alt="">
            <div class="deskripsi_kepengurusan mt-3">
              <p>Nama : JIANTO</p>
              <p>Sebagai : HUMAS 4</p>
            </div>
          ...
          <div class="container-card">
            <img class="image_kepengurusan" src="img/ketuacabangi.jpg" alt="">
            <div class="deskripsi_kepengurusan mt-3">
              <p>Nama : EKAN N</p>
              <p>Sebagai : ADVOKASI 1</p>
            </div>
          </div>
          <div class="container-card">
            <img class="image_kepengurusan" src="img/advokasi2.jpg" alt="">
            <div class="deskripsi_kepengurusan mt-3">
              <p>Nama : CATUR P</p>
              <p>Sebagai : ADVOKASI 2</p>
            </div>
          </div>
      </div>
    </main>
...
<!-- <p class="kepengurusan">
                ...
                ADVOKASI :
                <br>
                1. LETTU INF Ekan Nurcahyo
                <br>
                2. PRAKA Catur Prasetyo SH, MH
            </p> -->